...
public class GenerateAbstractOperationsOld extends OperationGeneratorOld<OperationGeneratorOld.OperationGeneratorContext> {

    private static final Logger log = LoggerFactory.getLogger(GenerateAbstractOperationsOld.class);

    public GenerateAbstractOperationsOld(Path task, GlobalPluginContext context) {
