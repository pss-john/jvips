...
public abstract class OperationGeneratorOld<A extends OperationGeneratorOld.OperationGeneratorContext> extends CodeGeneratorOld<A, TypeSpec> {

    private static final Logger log = LoggerFactory.getLogger(OperationGeneratorOld.class);

    protected final RecordGenerator recordGenerator;

    public OperationGeneratorOld(Path task, GlobalPluginContext context, OperationContext operationContext) {
    ...
    /**
     * Do not add parameter to method spec {@link GenerateAbstractOperationsOld#buildWithDTOOptionalParam(TypeSpec.Builder, MethodSpec.Builder, AbstractExecutable, List, TypeName, ParameterSpec)}
     *
     *
     * @param typeSpec
     * @param methodSpec
